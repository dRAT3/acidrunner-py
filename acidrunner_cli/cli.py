...
@app.command()
def run(
        config_file:  Optional[Annotated[str, typer.Option("-f", help="File to scan for configs")]] = None,
        runs: Annotated[int, typer.Option("-r", help="Number of runs will override the amt of runs in the config file.")] = 1,
    ):
    print(42*"*")
